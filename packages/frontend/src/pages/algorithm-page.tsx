  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center gap-3 px-6 py-3 shrink-0">
        ...
        <h1 className="text-xl font-semibold text-gray-800 dark:text-white">{meta.title}</h1>
        ...
        {meta.description && (
          <button
            ...
            className="ml-auto text-xs px-3 py-1 rounded-xl glass-light hover:bg-white/50 dark:hover:bg-gray-700/50 transition-colors text-slate-500 dark:text-gray-400"
          >
            {showIntro ? '收起介绍' : '展开原理'}
          </button>
        )}
      ...
      {showIntro && meta.description && (
        <div className="px-6 pb-3 shrink-0">
          <div className="glass-elevated rounded-xl px-4 py-3 text-sm text-slate-600 dark:text-gray-300 leading-relaxed max-h-32 overflow-y-auto">
            {meta.description}
          </div>
        </div>
      )}
