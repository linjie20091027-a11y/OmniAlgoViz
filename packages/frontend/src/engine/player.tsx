    ...
    <div className="flex flex-col h-full">
      ...
      <div className="glass-elevated rounded-2xl mx-4 mt-4 px-4 py-3 flex items-center gap-4 shrink-0">
        <div className="flex items-center gap-2">
          ...
          {state !== 'playing' ? (
            <button onClick={play} className="p-2 rounded-xl glass-light hover:bg-white/50 transition-colors" title="播放">
            ...
            <button onClick={pause} className="p-2 rounded-xl glass-light hover:bg-white/50 transition-colors" title="暂停">
        ...
        <div className="flex items-center gap-3 text-xs text-slate-500">
          <button onClick={() => goToStep(step - 1)} className="p-1.5 rounded-lg hover:bg-white/50 transition-colors" title="上一步">
          ...
          <button onClick={() => goToStep(step + 1)} className="p-1.5 rounded-lg hover:bg-white/50 transition-colors" title="下一步">
